...
working()
{
	for map in "roundmap" "input2" "duplicatepipe1" "input3" "underflow" "invalidcommand" "comments" "diamond" "simple1" "overflow" "loop" "hardmap" "cobmap" "map10" "testbug" "pentagram" "input1" "in0" "map14" "map42" "input0" "maptest" "triforce" "shortest" "test" "Chloe" "toile" "multiplewaysmap" "toile2" "europe_utf" "europe" "42" "bmap" "big" "mmkr2";
	do
	header;
